...
public class create_data {
	...
	public static String getInfo() {
		String infoName = getChineseName();
		String infoSex = getSex();
		String infoEmail = getEmail(6, 9);
		String infoSchool = getSchool();
		String infoAddress = getAddress();
		String infoTel = getTel();
		String result = "name:" + infoName + ",sex:" + infoSex
				+ ",email:" + infoEmail + ",school:" + infoSchool + ",tel:"
				+ infoTel + ",address:" + infoAddress +"\n";
		return result;
	}
/**
 * 生成数据封装成json
 ...
 */
	...
	public static void main(String[] args) throws IOException {
		...
		//生成数据路径
		FileWriter fw=new FileWriter("src/50G.txt");
		  for (int i = 0; i <390000000 ; i++) {  
              fw.write(getInfo());  
              if(count==1000000){
              	fw.flush();
              	System.out.println("finshed:" + j);
              	count=0;
              }
              count++;
              j++;
