package cn.guet2309.webcollector;
...
public class YahooCrawler extends BreadthCrawler {
    ...
    public YahooCrawler(String crawlPath, boolean autoParse) {
        ...
        /*start page*/
        this.addSeed("http://www.sina.com.cn/");

        /*fetch url like http://www.sina.com.cn/xxxxx*/
        this.addRegex("http://www.sina.com.cn/.*");
        /*do not fetch url like http://www.sina.com.cn/xxxx/xxx)*/
        this.addRegex("-http://www.sina.com.cn/.+/.*");
    ...
    public void visit(Page page, Links nextLinks) {
        ...
        if (Pattern.matches("http://www.sina.com.cn/.+html", url)) {
